        ...
        return(
            <div className="flex flex-wrap justify-center gap-5 space-y-6 md:p-6 ">
                <div className='space-y-6 '>
                    <div>
                        <p className="capitalize label font-extrabold text-[30px] text-red-500">Step 4 </p>
                        <span className="text-red-500 label">Booking details and payment processing</span>
                    </div>
                    <div className="flex space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center justify-between mt-2">
                                <span className="text-sm text-gray-500">Qty: {count}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='p-4 space-y-6 '>
                        {
                            ...
                            <div className="p-4 space-y-3 bg-gray-50 rounded-xl">
                                ...
                                <div className="flex justify-between text-xl font-bold">
                                    <span className="text-gray-900">Total Wallet</span>
                ...
                <div className=''>

                    {
                        ...
                        <div>
                            ...
                            <p className="capitalize label font-extrabold text-[30px] text-red-500">Step 1 </p>
                            <span className="text-red-500 label">Select tab offers to see price details</span>
                            ...
                            (
                                ...
                                :
                                    ...
                                    <div className="flex flex-wrap justify-center gap-5 p-6 bg-white ">
                                        <div className='space-y-6 '>
                                            <div>
                                                <p className="capitalize label font-extrabold text-red-500 text-[30px]">Step 2 </p>
                                                <span className="text-red-500 label">Manually adjust your booking by adding your e-wallet and the number of guests</span>
                                            </div>
                                            <div className='space-y-6'>
                                        ...
                                        <div className='space-y-6 md:flex md:flex-wrap md:justify-center '>
                                            ...
                                            <div className=' space-y-6 md:w-[450px]'>
                                                ...
                                                <div className="space-y-3">
                                                    <div>
                                                        <p className="capitalize label font-extrabold text-red-500 text-[30px]">Step 3 </p>
                                                        <span className="text-red-500 label">Proceed to setting up guest information and review the final details of your booking</span>
                                                    </div>
                                                    <div className="flex items-center justify-between ">
                                                        <div>
