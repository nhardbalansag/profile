            ...
            <div className="max-w-md p-5 mx-auto space-y-6 bg-white border shadow-lg md:p-6 rounded-2xl ">
                <div className='space-y-6'>
                    <div className='mt-3 space-y-2'>
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <label className="text-black text-[12px]">{offersData.content_days_count} Days</label>
                        </div>
                        <div className="flex items-center space-x-2">
                            <IoCloudyNightOutline   className="text-[15px] text-[#FF5722]" />
                            <label className="text-black text-[12px]">{offersData.content_night_count} Nights</label>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className='space-y-2'>
                        ...
                        <p className='text-[12px] text-gray-500'>(note: maximum guest is {`${offersData.content_guest_count}`})</p>
                        </div>
                    </div>
                </div> 
                ...
                <div className="flex items-center justify-between p-4 border border-blue-500 rounded-lg bg-blue-50">
                    <div>
                        ...
                        <p className="text-sm text-gray-500">{tabData.offers_table.supplier_table.room_type.room_type_guest_count} guest per room</p>
                ...
                <div className="space-y-4 border-b-[1px] pb-3">
                    ...
                    <div className='flex items-center justify-between'>
                        ...
                        <p className='text-[11px] ml-2 text-black font-semibold'>${tabData.offers_table.offers_points_amount} USD</p>
                    </div>
                    <div className='flex items-center'>
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between pt-4">
                        <div>
                            <p className="text-lg text-[24px] font-bold underline">${finalAmount} USD</p>
                        </div>
